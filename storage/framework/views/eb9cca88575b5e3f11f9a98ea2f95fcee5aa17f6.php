                ...
                <div class="col-11">
                    <div class="row justify-content-center">
                            ...
                            <div class="profile-details p-4">
                                ...
                                <div class="profile-menu px-3 mt-4 mb-5">
                                    <ul class="list-group" id="tabs-nav">
                                        ...
                                        <a href="#tab3"
                                           class="list-group-item d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0"> <img src="<?php echo e(asset('assets/dashboard/img/security.png')); ?>" alt="icon">
                                                Segurança</h5>
                                            <span class=""><i class="icofont-simple-right"></i></span>
                                        </a>
                                        <a href="#tab4"
                                           class="list-group-item d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0"> <img src="<?php echo e(asset('assets/dashboard/img/question.png')); ?>" alt="icon"> Ajuda
                                            </h5>
                                            <span class=""><i class="icofont-simple-right"></i></span>
                                        </a>
                                    </ul>
                        ...
                        <div class="col-6">
                            ...
                            <div class="profile-items p-5 tab-content" id="tab4">
                                <h5>
                                    Ajuda
                                </h5>
                            </div>
...
<?php echo $__env->make('dashboard.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xamp\htdocs\loan-management\resources\views/dashboard/user/myprofile.blade.php ENDPATH**/ ?>